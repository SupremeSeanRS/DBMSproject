    ...
    <div class="row mt-1 mx-auto col-lg-10 ">
        ...
        <div class="container mb-5 col-lg-4 mt-5">
            <table>
                ...
                $sql = "SELECT recipe.recName FROM breakfast JOIN recipe ON breakfast.recID=recipe.recID WHERE breakfast.uName='{$name}'";
        ...
        <div class="container mb-5 col-lg-4 mt-5">
            <table>
                ...
                $name = ($_SESSION["username"]);
                $sql1 = "SELECT recipe.recName FROM lunch JOIN recipe ON lunch.recID=recipe.recID WHERE lunch.uName='{$name}' ";
        ...
        <div class="container mb-5 col-lg-4 mt-5">
            <table>
                ...
                $name = ($_SESSION["username"]);
                $sql1 = "SELECT recipe.recName FROM dinner JOIN recipe ON dinner.recID=recipe.recID WHERE dinner.uName='{$name}' ";
                $result1 = $conn->query($sql1);
                if (isset($result1->num_rows) && $result1->num_rows > 0) {
